    ...
    private void setupSearchListener() {
        jTextField3.getDocument().addDocumentListener(new DocumentListener() {
            public void insertUpdate(DocumentEvent e) {
                loadAssignmentDetails(jTextField3.getText().trim());
            }
...
//                vector.add(resultSet.getString("assignment.description"));
    ...
    private void reset() {
        ...
        jTextField2.setText("");
        jComboBox2.setSelectedItem("NIC ASC");
        jTextField3.setText("");
        loadAssignmentDetails("");
        jButton1.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NIC ASC", "NIC DESC", "Marks ASC", "Marks DESC", "ID ASC", "ID DESC" }));
        ...
        jButton4.setText("Clear Search and Sort");
